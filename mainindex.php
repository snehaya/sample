	...
	<body class="container">
		...
		//function to send message
			function sendMsg() {
				...
				//it will going to send message request to sendmsg.php
			...
			function showMsg() {
				...
				//to send request to sendmsg.php
			...
			function showMsgchat() {
				...
				xmlhttp.onload = function() {
					...
					if(datas){
						...
						//after 1 sec hide the loading animation
						setTimeout(function() {
